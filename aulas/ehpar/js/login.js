window.addEventListener("load", function () {
    ...
    function processarLogin(user, pwd) {
        if (typeof(Storage) != "undefined") {
            ...
            if (!usuarios) alertWifi(`Usuário inexistente. Tente um usuário diferente!`, false, 0, "img/logo.png", 30, "");
            else {
                ...
                else alertWifi(`Usuário inexistente. Tente um usuário diferente!`, false, 0, "img/logo.png", 30, "");
            }
        }
        else alertWifi(`Problemas no navegador. Não será possível executar o jogo!`, false, 0, "img/logo.png", 30, "");
    }
});
